...
If you find a bug in the source code, you can help us by [submitting an issue](https://github.com/BrandonManuel/git-chglog/issues) to our [GitHub Repository](https://github.com/BrandonManuel/git-chglog). Even better, you can submit a Pull Request with a fix.
